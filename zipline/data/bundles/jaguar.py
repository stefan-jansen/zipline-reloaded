...
def jaguar_ingest(tframes=None, dir=None, instType='SWAP'):
    """
...
def sandbank_bundle(
    ...
    if not dir:
        ...
        if not dir:
            raise ValueError("JAGUAR environment variable is not set")
...
register_calendar_alias("JAGUAR", "CRYPTO")
